...
% As is readily apparent from the figure, participants tap, Force Touch has a more strong intuitive operation. In light point, the user there are two obvious differences, some people think that the operating logic of the operation more in line with the tap should slide between thumb and forefinger, the other person is considered to be more suitable operating logic of the thumb and index finger fast kneading. % Reason this happens is:% ***** (temporarily thought to understand why this is so ..)
...
% For sliding around, return, special buttons fist implement this part of the design, the user does not feel the more obvious interaction logic and intuitive operation. Fortunately, the Apple Watch this vertical upflow Display device information, interactive slide about common enough, and a return part of the more sensitive operations, the use of the operation is not in line with the logic of the operation but can improve the user vigilance, prevent misuse.
